 ...
 */
final class Version20260123200112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE action_card (type VARCHAR(255) NOT NULL, id INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE character_card (type VARCHAR(255) NOT NULL, max_damage SMALLINT NOT NULL, id INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, location VARCHAR(255) NOT NULL, game_id INT NOT NULL, action_card_id INT NOT NULL, INDEX IDX_5E9E89CBE48FD905 (game_id), INDEX IDX_5E9E89CB906E12C1 (action_card_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE place_card (id INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE player (id INT AUTO_INCREMENT NOT NULL, current_damage SMALLINT NOT NULL, revealed TINYINT NOT NULL, game_id INT NOT NULL, user_id INT NOT NULL, position_id INT DEFAULT NULL, INDEX IDX_98197A65E48FD905 (game_id), INDEX IDX_98197A65A76ED395 (user_id), INDEX IDX_98197A65DD842E46 (position_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE position (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, place_card_id INT DEFAULT NULL, INDEX IDX_462CE4F5E48FD905 (game_id), INDEX IDX_462CE4F57E008DDB (place_card_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
